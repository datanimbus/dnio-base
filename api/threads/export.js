...
async function execute() {
    ...
    try {
        let serviceDetails = await commonUtils.getStoredServiceDetail(config.serviceId, serviceDetailsObj, reqData);
        ...
        if (filter) {
            ...
            filter = await exportUtils.createFilter(_sd, filter, reqData)
        }
